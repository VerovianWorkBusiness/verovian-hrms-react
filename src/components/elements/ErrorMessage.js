...
const ErrorMessage = ({toggleClose, messageTitle, messageText}) => {
  return (
    <div className='relative rounded-md text-white p-4 bg-red-700 shadow-lg shadow-red-500/30 transition duration-200  animate__animated animate__fadeIn' style={{width: '300px'}}>
